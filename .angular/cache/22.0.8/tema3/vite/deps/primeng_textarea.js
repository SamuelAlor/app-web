import {
  BaseModelHolder
} from "./chunk-VLK3FXSB.js";
import {
  NgControl
} from "./chunk-HKCVGDKA.js";
import {
  Fluid
...
import "./chunk-LZW7E2AV.js";
import "./chunk-EYMFUDBV.js";
import "./chunk-TZXUY4MK.js";
...
var Textarea = class _Textarea extends BaseModelHolder {
   ...
   * @group Props
   */
  autoResize = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
   ...
   * @group Props
   */
  invalid = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "invalid"
  } : (
    /* istanbul ignore next */
    {}
