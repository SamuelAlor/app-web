...
function Box_For_1_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵnamespaceSVG();
...
function Box_For_1_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵnamespaceSVG();
    ɵɵdomElement(0, "rect");
  }
...
function Box_For_1_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵnamespaceSVG();
    ɵɵdomElement(0, "line");
  }
...
function Box_For_1_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵnamespaceSVG();
...
function Box_For_1_Case_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵnamespaceSVG();
...
function Box_For_1_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵnamespaceSVG();
...
function Box_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵconditionalCreate(0, Box_For_1_Case_0_Template, 1, 9, ":svg:path")(1, Box_For_1_Case_1_Template, 1, 6, ":svg:circle")(2, Box_For_1_Case_2_Template, 1, 9, ":svg:rect")(3, Box_For_1_Case_3_Template, 1, 7, ":svg:line")(4, Box_For_1_Case_4_Template, 1, 4, ":svg:polyline")(5, Box_For_1_Case_5_Template, 1, 4, ":svg:polygon")(6, Box_For_1_Case_6_Template, 1, 7, ":svg:ellipse");
  }
  if (rf & 2) {
    let tmp_10_0;
...
var Box = class _Box extends CoreIcon {
  constructor() {
    super();
    this._icon = C;
  }
  static ɵfac = function Box_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Box)();
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _Box,
    selectors: [["svg", "data-p-icon", "box"]],
    features: [ɵɵInheritDefinitionFeature],
    decls: 2,
    vars: 0,
    template: function Box_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵrepeaterCreate(0, Box_For_1_Template, 7, 1, null, null, _forTrack0);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Box, [{
    type: Component,
    args: [{
...
//# sourceMappingURL=@primeicons_angular_box.js.map
